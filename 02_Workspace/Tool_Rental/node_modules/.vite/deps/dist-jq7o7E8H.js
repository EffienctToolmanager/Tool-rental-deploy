...
var BrowserCacheManager = class extends CacheManager {
	...
	*/
	trackVersionChanges(correlationId) {
		...
		if (previousVersion !== "5.9.0") this.setItem(VERSION_CACHE_KEY, version, correlationId);
	}
	/**
...
function getPerfMeasurementModule() {
	...
	try {
		...
		if (Number(perfEnabled) === 1) return import("./BrowserPerformanceMeasurement-BYaRuynB.js").then((n) => n.n);
	} catch (e) {}
}
/**
...
//# sourceMappingURL=dist-jq7o7E8H.js.map